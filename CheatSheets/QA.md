...
| Команда/роль | Форматы взаимодействия |
|---|---|
| **Разработчики (Dev)** | - Совместный анализ требований и багов 
- Уточнение технических деталей 
- Передача информации о нестабильных фичах 
- Совместная отладка дефектов 
- Использование общих каналов связи (Slack, Jira, Confluence) |
| **Бизнес-аналитики (BA)** | - Уточнение требований и бизнес-правил 
- Выявление неоднозначностей 
- Совместное составление acceptance-критериев 
- Участие в приемочном тестировании |
| **DevOps/Инфраструктура** | - Настройка и поддержка стендов 
- Работа с логами и мониторингами 
- Автоматизация развёртывания 
- Поддержка CI/CD пайплайнов 
- Разграничение доступов и параметров конфигурации |
| **Техподдержка и эксплуатация** | - Передача воспроизводимых багов 
- Анализ инцидентов с продакшена 
- Подготовка сценариев для smoke-тестов и чек-листов 
- Проверка стабильности после релизов |
| **Менеджмент (Project/Product)** | - Отчёты о качестве, дефектах, прогрессе 
- Аргументированная оценка готовности к релизу 
- Обоснование потребности в ресурсах и приоритетах 
...
| Критерий | Варианты / Значения |
|----------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Severity (серьёзность)** | - Blocker: невозможно продолжать работу 
- Critical: отказ ключевого функционала 
- Major: значительный, но не блокирующий дефект 
- Minor: незначительное отклонение 
- Trivial: косметическая ошибка |
| **Priority (приоритет)** | - High: исправление требуется немедленно 
- Medium: важно, но не срочно 
- Low: может быть отложено |
| **Status (статус)** | - New/Open 
- Assigned 
- In Progress 
- Resolved 
- Reopened 
- Closed |
| **Type (тип дефекта)** | - Functional 
- UI/UX 
- Performance 
- Compatibility 
- Security (если не относится к ZI, может упоминаться для оценки покрытия) 
- Regression 
- Localization |
