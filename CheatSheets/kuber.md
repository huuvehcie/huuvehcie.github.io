1. [Архитектура и основные компоненты Kubernetes](#архитектура-и-основные-компоненты-kubernetes)
2. [Операции в Kubernetes](#операции-в-kubernetes)
3. [Основные термины Kubernetes](#основные-термины-kubernetes)
