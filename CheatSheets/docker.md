1. [Архитектура и основные компоненты Docker](#архитектура-и-основные-компоненты-docker)
2. [Основные термины Docker](#основные-термины-docker)
3. [Операции в Docker](#операции-в-docker)
4. [Пример docker файла](#пример-docker-файла)
