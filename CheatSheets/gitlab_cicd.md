...
2. [Руководство по настройке и запуску CI/CD pipeline](#2-руководство-по-настройке-и-запуску-cicd-pipeline)
   - [1. Основы CI/CD pipeline](#21-основы-cicd-pipeline)
   - [2. Настройка pipeline](#22-настройка-pipeline)
   - [3. Выполнение задач](#23-выполнение-задач)
   - [4. Продвинутые сценарии](#24-продвинутые-сценарии)
   - [5. Совместимость и оптимизация](#25-совместимость-и-оптимизация)
