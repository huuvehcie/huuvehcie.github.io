1. [Принципы работы облачной инфраструктуры](#принципы-работы-облачной-инфраструктуры)
   1. [Определения](#определения)
   2. [Уровни облачных сервисов](#уровни-облачных-сервисов)
2. [Компоненты облачных сервисов по функциональности](#компоненты-облачных-сервисов-по-функциональности)
3. [Компоненты облачных сервисов по уровням сервиса](#компоненты-облачных-сервисов-по-уровням-сервиса)
