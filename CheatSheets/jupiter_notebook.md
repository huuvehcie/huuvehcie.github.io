...
* ## [🧭 Панель команд (Command Palette)](#Панель-команд-(Command-Palette))
    ...
    * ### [📘 Технические пояснения для новичков](#Технические-пояснения-для-новичков)
    * ### [💡 Советы практика](#Советы-практика)
* ## [📂 Меню (Menu Bar)](#Меню-(Menu-Bar))
    * ### [🧩 Назначение](#Назначение-1) * ### [🔐 Использование в пентесте](#Использование-в-пентесте-1)
    * ### [🧪 Использование в QA](#Использование-в-QA-1)
    * ### [⚙️ Возможности](#Возможности-1)
    * ### [🔬 Описание работы](#Описание-работы-1)
    * ### [✅ Примеры задач](#Примеры-задач-1)
    * ### [🛡 Особенности безопасности](#Особенности-безопасности-1)
    * ### [📘 Технические пояснения для новичков](#Технические-пояснения-для-новичков-1)
    * ### [💡 Советы практика](#Советы-практика-1)
* ## [📁 Панель файлов (File Browser)](#Панель-файлов-(File-Browser))
    * ### [🧩 Назначение](#Назначение-2)
    * ### [🧪 Использование в QA](#Использование-в-QA-2)
    * ### [🔐 Использование в пентесте](#Использование-в-пентесте-2)
    * ### [⚙️ Возможности](#Возможности-2)
    * ### [📘 Технические детали](#Технические-детали)
    * ### [✅ Примеры QA-задач](#Примеры-QA-задач)
    * ### [🛡 Особенности безопасности](#Особенности-безопасности-2)
    * ### [📊 Таблица контроля и настройки](#Таблица-контроля-и-настройки)
    * ### [💡 Советы практика](#Советы-практика-2)
* ## [🧠 Редактор и кодовые ячейки (Code Cells & Editor)](#Редактор-и-кодовые-ячейки-(Code-Cells-&-Editor))
    * ### [🧩 Назначение](#Назначение-3)
    * ### [⚙️ Возможности](#Возможности-3)
    * ### [🔎 Примеры задач в QA](#Примеры-задач-в-QA)
    ...
    * ### [💡 Советы практика](#Советы-практика-3)
* ## [🔗 Терминал (Terminal)](#Терминал-(Terminal))
    * ### [🧩 Назначение](#Назначение-4)
    * ### [⚙️ Возможности](#Возможности-4)
    * ### [🔎 Примеры задач в QA](#Примеры-задач-в-QA-1)
    * ### [🛠 Примеры задач в пентесте](#Примеры-задач-в-пентесте)
    * ### [🔐 Аспекты безопасности](#Аспекты-безопасности)
    * ### [🧪 Тесты QA через терминал](#Тесты-QA-через-терминал)
    * ### [🧱 Советы практика](#Советы-практика-4)
* ## [📊 Просмотр (Notebook Viewer / Rendered Output)](#Просмотр-(Notebook-Viewer-/-Rendered-Output))
    ...
    * ### [🧪 Примеры задач в QA](#Примеры-задач-в-QA-2)
    * ### [🔐 Аспекты безопасности](#Аспекты-безопасности-1)
    ...
    * ### [💡 Советы практика](#Советы-практика-5)
* ## [📑 Markdown и Rich Text редактор](#Markdown-и-Rich-Text-редактор)
    ...
    * ### [🔐 Уязвимости и безопасность](#Уязвимости-и-безопасность)
