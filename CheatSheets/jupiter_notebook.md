📑 Содержание Полное руководство по Jupyter Notebook для QA, Dev, Pentest

1. [Общее описание Jupyter Notebook](#1-общее-описание-jupyter-notebook)
2. [Установка и запуск Jupyter Notebook](#2-установка-и-запуск-jupyter-notebook)  
  2.1 [Установка через pip и conda](#21-установка-через-pip-и-conda)  
  2.2 [Запуск из терминала](#22-запуск-из-терминала)  
  2.3 [Конфигурация и запуск как службы](#23-конфигурация-и-запуск-как-службы)  

3. [Структура и интерфейс Jupyter Notebook](#3-структура-и-интерфейс-jupyter-notebook)  
  3.1 [Элементы интерфейса](#31-элементы-интерфейса)  
  3.2 [Типы ячеек и режимы](#32-типы-ячеек-и-режимы)  

4. [Горячие клавиши и управление ячейками](#4-горячие-клавиши-и-управление-ячейками)  
  4.1 [Навигация по ячейкам](#41-навигация-по-ячейкам)  
  4.2 [Редактирование и выполнение](#42-редактирование-и-выполнение)  

5. [Работа с ядрами (kernels)](#5-работа-с-ядрами-kernels)  
  5.1 [Перезапуск, остановка и переключение ядра](#51-перезапуск-остановка-и-переключение-ядра)  

6. [Работа с файлами и путями](#6-работа-с-файлами-и-путями)  
  6.1 [Чтение и сохранение данных](#61-чтение-и-сохранение-данных)  

7. [Расширения (nbextensions) и настройки](#7-расширения-nbextensions-и-настройки)  
  7.1 [Установка Jupyter nbextensions](#71-установка-jupyter-nbextensions)  
  7.2 [Полезные расширения](#72-полезные-расширения)  

8. [Интеграция с Git и управление версиями](#8-интеграция-с-git-и-управление-версиями)

9. [Использование магических команд](#9-использование-магических-команд)  
  9.1 [Команды % и %%](#91-команды--и-)  

10. [Безопасность и конфигурация доступа](#10-безопасность-и-конфигурация-доступа)  
  10.1 [Пароли, токены и HTTPS](#101-пароли-токены-и-https)  

11. [Полезные приёмы и советы практика](#11-полезные-приёмы-и-советы-практика)

12. [Типичные ошибки и способы устранения](#12-типичные-ошибки-и-способы-устранения)

13. [JupyterLab: краткое сравнение с Jupyter Notebook](#13-jupyterlab-краткое-сравнение-с-jupyter-notebook)

14. [Альтернативы и совместимые среды](#14-альтернативы-и-совместимые-среды)

15. [Мини-чеклист по эксплуатации](#15-мини-чеклист-по-эксплуатации)

16. [Примеры команд и сниппетов](#16-примеры-команд-и-сниппетов)
